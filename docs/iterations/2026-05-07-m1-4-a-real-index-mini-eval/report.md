...
原始 JSONL 路径（同 baseline 一样不入库；列出便于 M1.4-b 复核与答辩追溯）：

- `20260507-191243` → `backend/var/eval/mini_eval_20260507-191243.jsonl`
- `20260507-191435` → `backend/var/eval/mini_eval_20260507-191435.jsonl`
- `20260507-191926` → `backend/var/eval/mini_eval_20260507-191926.jsonl`
